...
public class Ball : MonoBehaviour {
    ...
    void Start () {
        ...
        //searches for Object of Type Paddle in the scene and assigns it to myPaddle
        myPaddle = GameObject.FindObjectOfType<Red_Paddle>();
